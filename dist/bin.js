...
_commander2["default"].version(_package2["default"].version).usage("[options] [<input> [<output>]]").option("-C, --config <file>", "use the config file").option("-b, --browsers <items>", "browsers list (comma separated)").option("-I, --no-import", "do not inline @import").option("-U, --no-url", "do not adjust url()").option("-e, --extract", "output values of custom properties").option("-c, --compress", "compress output").option("-s, --sourcemap", "add sourcemap").option("-w, --watch", "watch the input file for changes").option("-v, --verbose", "verbose output");
...
config.extract = _commander2["default"].extract;
